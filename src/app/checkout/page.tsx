...
import type { OrderAddress } from "@/src/lib/types"
import { createOrder, calculateTax } from "@/src/lib/api"
  ...
  const handlePaymentComplete = async (paymentDetails: any) => {
    ...
    try {
      ...
      const order = await createOrder({
        ...
        email: shippingAddress?.email || "customer@example.com", // In a real app, this would come from the user's account or checkout form
      })
