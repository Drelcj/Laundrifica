...
export function AreaChart(props: React.ComponentProps<typeof AreaChartComponent>) {
  return <AreaChartComponent {...props} />
}

export function BarChart(props: React.ComponentProps<typeof BarChartComponent>) {
  return <BarChartComponent {...props} />
}

export function LineChart(props: React.ComponentProps<typeof LineChartComponent>) {
...
export function ChartTooltip({ children }: { children: React.ReactNode }) {
  return <div className="p-2 bg-white shadow-md rounded-md">{children}</div>
}
...
export { ChartContainerComponent, ChartTooltipContent, ChartLegend, ChartLegendContent, ChartStyle }
