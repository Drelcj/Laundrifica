      ...
      <div className="container max-w-4xl mx-auto text-center px-4">
        <div className="space-y-6">
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-bold">Stay Updated with LaundryLab</h2>
          ...
          <p className="text-sm text-muted-foreground">
            Join thousands of satisfied customers who trust LaundryLab for their fabric care needs.
          </p>
        </div>
      </div>
    </section>
